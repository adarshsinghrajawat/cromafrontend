...
export default function Received() {
    ...
    const [returnDate, setReturnDate] = useState('') // Added new date state
    ...
    const handleReset = () => {
        ...
        setReturnDate('') // Reset the date field as well
    }
    ...
    const validation = () => {
        ...
        if (returnDate.length === 0) {  // Validate the new date field
            error = true
            handleError('Please select a date', 'returndate')
        }
        if (time.length === 0) {
            error = true;
    ...
    const handleSumit = async () => {
        ...
        if (error === false) {
            ...
            formData.append('returndate', returnDate) // Send the date in the form data
            ...
            var response = await postData('productdetails/submit_received', formData)
        ...
        <div className={useStyle.root}>
            <div className={useStyle.box}>
                <Grid container spacing={3}>
                    <Grid item xs={12}>
                        <Heading image={logo1} caption="Received Form" link='/dashboard/totalreceived' />
                    </Grid>
                                   ...
                                   <Grid item xs={4}>
                                                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                                                                <TimePicker
                                                                    ...
                                                                    renderInput={(params) => <TextField {...params} fullWidth label="Time Of Return"
